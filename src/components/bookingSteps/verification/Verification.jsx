...
export default function Verification({ setActiveStep, handleSeatSelection }) {
  ...
  const handleSubmit = () => {
    ...
    apiClient
      .orderSeats(user, departure, arrival ? arrival : null)
      .then(() => {
      ...
      .catch((error) => {
        ...
        dispatch(
          showSnackBar({
            message:
              "Ошибка при бронировании мест. Пожалуйста, попробуйте еще раз.",
            type: "error",
          })
        );
      });
      ...
      <div className="booking-steps__container verification__payment">
        ...
        <div className="verification__payment-container">
          ...
          <div className="verification__aside">
            <button
              className="secondary-btn verification__payment-btn"
