...
export default function Wagon({ currentTrip, services, schemeImg }) {
  return (
    <div className="seat-selector__wagon wagon">
      <div className="wagon__number-container">
        <span className="wagon__number">12</span>
      ...
      <div className="seat-selector__details">
        ...
        <div className="seat-selector__details-group">
          ...
          <div className="seat-selector__price">
            ...
            <span className="seat-selector__price-currency">
              <svg
      ...
      <div className="seat-selector__img">
...
Wagon.propTypes = {
  ...
  schemeImg: PropTypes.string.isRequired,
};
