   ...
   return (
     ...
     >
       <div className="passenger-details__header">
         <h3
           className={`passenger-details__title`}
         >
             Пассажиры
         </h3>
         <button
           ...
           >
            ...
            <div className="passenger-details__content">
               <span className="passenger-details__count">
                  {passengers.adult === 1 ? `${passengers.adult} Взрослый` : `${passengers.adult} Взрослых`}
                  </span>
            ...
            <div className="passenger-details__content">
            <span className="passenger-details__count">
                  {passengers.children === 1 ? `${passengers.children} Ребенок` : `${passengers.children} Детей`}
                  </span>
                  <span className="passenger-details__price">
                  {price.children} 
                  </span>
